...
### 4. 영화 추천 기능
  - 자신이 좋아하는 장르에서 무작위 / 평점순 / 인기순 에 따라 영화 추천
...
|movie_like_users|ManyToMany(settings.AUTH_USER_MODEL)|
...
|updated_at|datetime|
|user_id|BigInt|
|like_users|ManyToMany(settings.AUTH_USER_MODEL)|
